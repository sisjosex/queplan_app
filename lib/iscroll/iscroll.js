...
iScroll.prototype = {
	...
	touchStart: function(e) {
		...
		if($(e.target).hasClass('button') || $(e.target).hasClass('btn') || $(e.target).hasClass('clickable') /*|| $(e.target).is('input') || $(e.target).is('textarea')*/ /*|| !$(e.target).hasClass('list-item')*/ ) {
			//e.stopPropagation();
			//e.preventDefault();
			return;
	...
	touchMove: function(e) {
		...
		if($(e.target).hasClass('button') || $(e.target).hasClass('btn')) {

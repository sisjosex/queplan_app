 ...
 *
 * Docs: http://code.google.com/p/google-api-javascript-client/
 * SRC: https://apis.google.com/js/client.js
 *
 * NOTE: It is not recommended to use this client src offline,
 * so, this should be updated peridiocally from the srouce URL.
 *
 * UPDATE (Jan 29, 2013) : Update GAPI client source code.
 */
